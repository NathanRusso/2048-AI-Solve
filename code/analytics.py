...
def main():
    model = Model2048()
    expectiminimax1 = Expectiminimax2048(5, True) # Search depth of 5 is a good balance
    expectiminimax2 = Expectiminimax2048(5, False) # Search depth of 5 is a good balance
